...
export class HomeComponent implements AfterViewInit, OnDestroy {
  ...
  solutions = [
    ...
    { name: 'Jumeau Numérique', desc: 'Créez une réplique virtuelle de vos produits, infrastructures, villes ou sites industriels pour concevoir, simuler et optimiser chaque décision.', logo: '/assets/solutions/jumeaux.jpeg', link: '/solutions/jumeau-numerique', color: 'linear-gradient(135deg, #002D5B, #C5A059)' },
